...
class Album:
    ...
    def addFaixa(self, titulo, artista=None):
        ...
        nroFaixa = len(self.__faixa)
        musica = Musica(titulo, artista, self, nroFaixa)
        self.__faixa.append(musica)
...
art1 = Artista('Soundgarden')
album1 = Album('Down on the Upside', art1, 1996)
album1.addFaixa('Rhinosaur')
album1.addFaixa('Zero Chance')
album1.addFaixa('Dusty')

playlist1 = Playlist('pl-Soundgarden')

for musica in album1.getFaixa():
