...
class Historico:
    ...
    def gerarHistorico(self, carga_obrigatoria, carga_eletiva):
        print('*********HISTORICO********')
        print(
            f'Aluno: {self.__aluno.getNome()} - Matricula: {self.__aluno.getNroMatricula()}')
        ...
        print(
            f'Carga horária de disciplina obrigatória: {carga_obrigatoria} horas')
        if carga_eletiva > 0:
            print(
                f'Carga horária de disciplina eletiva: {carga_eletiva} horas')
